...
const About = () => {
  return (
    <div className='text-white h-[120vh]  w-screen bg-[#0D0C1A] mt-10 bg-[url("../../public/Ellipse14.png")]  bg-center bg-cover bg-opacity-10 bg-blend-screen bg-no-repeat p-5 md:p-16'>
